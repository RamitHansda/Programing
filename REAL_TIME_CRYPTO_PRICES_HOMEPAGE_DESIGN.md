...
| Decision | Rationale |
|----------|-----------|
| **Canonical price model + protocol adapters** | Single schema and single ingest path; add exchanges without changing downstream; aligns with [protocol adapters design](src/main/java/lld/protocol-adapters/PROTOCOL_ADAPTERS_DESIGN.md). |
