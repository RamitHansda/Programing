...
> Looking for the full catalog of LLD interview questions (not just one-per-pattern)? See [LLD_SYSTEM_DESIGN_INTERVIEW_QUESTIONS.md](./LLD_SYSTEM_DESIGN_INTERVIEW_QUESTIONS.md).
